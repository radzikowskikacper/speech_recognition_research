...
class handler:
    ...
    def transformData_Kaldi_easier_tut(self, output_dir, test_speakers):
        if os.path.exists(output_dir):
            shutil.rmtree(output_dir)
        os.makedirs('{}/exp'.format(output_dir))
        os.makedirs('{}/conf'.format(output_dir))
        os.makedirs('{}/data/lang'.format(output_dir))
        os.makedirs('{}/data/train'.format(output_dir))
        os.makedirs('{}/data/local/lang'.format(output_dir))
